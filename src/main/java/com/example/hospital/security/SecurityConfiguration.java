    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(
                        customizer ->
                                customizer
//
                                        .requestMatchers("/pacientes/form").hasAnyRole("ADMIN", "RECEPCIONISTA")
                                        .requestMatchers("/pacientes/list").hasAnyRole("ADMIN","USER", "RECEPCIONISTA", "MEDICO")
                                        .requestMatchers("/medicos/form").hasAnyRole("ADMIN", "MEDICO")
                                        .requestMatchers("/medicos/list").hasAnyRole("ADMIN", "MEDICO")
                                        .requestMatchers("/consultas/consulta").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                                        .requestMatchers("/consultas/form").hasAnyRole("ADMIN", "RECEPCIONISTA")
                                        .requestMatchers("/consultas/list").hasAnyRole("ADMIN", "RECEPCIONISTA", "MEDICO")
                                        .anyRequest().authenticated()
                )
                .formLogin(customizer ->
                        customizer
                                .loginPage("/login")
                                .defaultSuccessUrl("/pacientes/list", true)
                                .permitAll()
                )
